...
<div class="wrap">
    ...
    <form name="intouch_form" method="post" action="<?php echo str_replace( '%7E', '~', $_SERVER['REQUEST_URI']); ?>">
        ...
        <div class="notice notice-success  themeisle-sdk-notice" id="otter_blocks_logger_flag-notification">
		<div class="themeisle-sdk-notification-box"><p>
		<span>Where is my Api key? </span> Your Api key is located within your account settings. Click 
		<a href="https://www.intouchcrm.co.uk/app/account/" target="_blank">here</a> 
		to login and then be automatically sent to your settings page. The key is on the right hand side at the bottom.
		</p></div></div>
        <hr />
        ...
        <div class="notice notice-success  themeisle-sdk-notice" data-notification-id="otter_blocks_logger_flag" id="otter_blocks_logger_flag-notification"> 
		<div class="themeisle-sdk-notification-box"><p><span>Where is My Affiliate ID? </span> Click <a href="http://intouch.postaffiliatepro.com/affiliates/" target="_blank">here</a> to get Affiliate ID. </p></div></div>
        ...
        <p>If you want to add new form then <a href=" https://www.intouchcrm.co.uk/app/settings/signupforms/" target="_blank"><?php _e('Click here' , 'intouch_admin'); ?></a></p>
		<?php 
			}
			else
